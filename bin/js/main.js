...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ReactDom = __webpack_require__(159);
	var swal = __webpack_require__(166);
	...
	var CommentBox = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            'div',
	            { className: 'title' },
	            this.state.showFlag ? React.createElement(QRCode, null) : '',
	            React.createElement(
	                'h1',
	                null,
	                '马 琨(Ma Kun)'
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'span',
	                    { className: 'skill label label-info' },
	                    'java'
	                ),
	                React.createElement(
	                    'span',
	                    { className: 'skill label label-success' },
	                    'javascript'
	                ),
	                React.createElement(
	                    'span',
	                    { className: 'skill label label-warning' },
	                    'mysql'
	                ),
	                React.createElement(
	                    'span',
	                    { className: 'skill label label-danger' },
	                    'oracle'
	                )
	            ),
	            React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'span',
	                        { className: 'fa-stack fa-lg', onClick: this._showLink.bind(null, 1) },
	                        React.createElement('i', { className: 'fa fa-circle-o fa-stack-2x' }),
	                        React.createElement('i', { className: 'fa fa-facebook fa-stack-1x' })
	                    )
	                ),
	                React.createElement(
	                    'li',
	                    ...
	                    React.createElement(
	                        'span',
	                        { className: 'fa-stack fa-lg', onClick: this._showLink.bind(null, 2) },
	                        React.createElement('i', { className: 'fa fa-circle-o fa-stack-2x' }),
	                        React.createElement('i', { className: 'fa fa-github fa-stack-1x' })
	                    )
	                ),
	                React.createElement(
	                    'li',
	                    ...
	                    React.createElement(
	                        'span',
	                        { className: 'fa-stack fa-lg', onClick: this._showLink.bind(null, 3) },
	                        React.createElement('i', { className: 'fa fa-circle-o fa-stack-2x' }),
	                        React.createElement('i', { className: 'fa fa-wechat fa-stack-1x' })
	                    )
	                )
	            )
	        );
	    ...
	    _showLink: function (type) {
	        switch (type) {
	            case 1:
	                window.location.href = "https://www.facebook.com/profile.php?id=100011125991941";break;
	            case 2:
	                window.location.href = "https://github.com/ksqb0156596";break;
	            case 3:
	                swal({ title: '', text: '', imageUrl: '../images/qrcode.png', imageSize: '300x300' });break;
	        }
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation = __webpack_require__(167);

	/*
	 * Handy utilities
	 */

	var _extend$hexToRgb$isIE8$logStr$colorLuminance = __webpack_require__(168);

	/*
	 *  Handle sweetAlert's DOM elements
	 */

	var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = __webpack_require__(169);

	// Handle button events and keyboard events

	var _handleButton$handleConfirm$handleCancel = __webpack_require__(172);

	var _handleKeyDown = __webpack_require__(173);

	var _handleKeyDown2 = _interopRequireWildcard(_handleKeyDown);

	// Default values

	var _defaultParams = __webpack_require__(170);

	var _defaultParams2 = _interopRequireWildcard(_defaultParams);

	var _setParameters = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hexToRgb = __webpack_require__(168);

	var _removeClass$getTopMargin$fadeIn$show$addClass = __webpack_require__(167);
	...
	var _injectedHTML = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorLuminance = __webpack_require__(168);

	var _getModal = __webpack_require__(169);

	var _hasClass$isDescendant = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stopEventPropagation$fireClick = __webpack_require__(167);

	var _setFocusStyle = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isIE8 = __webpack_require__(168);

	var _getModal$getInput$setFocusStyle = __webpack_require__(169);

	var _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide = __webpack_require__(167);
